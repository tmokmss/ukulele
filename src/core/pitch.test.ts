...
/** 弦1本を鳴らした時間波形 */
function renderString(midi: number, cents: number, partials = PARTIALS): Float64Array {
...
function detectCents(midi: number, cents: number, partials = PARTIALS): number | null {
